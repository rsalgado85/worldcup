    ...
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="space-y-2">
        <div className="flex items-center gap-3">
          <Building2 size={28} className="text-neon-blue" />
      ...
      >
        {stadiums?.map((stadium, i) => (
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="glass rounded-xl p-4 border border-border-subtle hover:border-neon-blue/20 transition-all"
          >
            <div className="w-full h-36 rounded-lg mb-3 bg-gradient-to-br from-neon-blue/10 to-neon-green/5 flex items-center justify-center">
              <Building2 size={48} className="text-neon-blue/20" />
            </div>
